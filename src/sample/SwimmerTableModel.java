...
import sample.remotes.SwimmerRemote;
import sample.rootElements.Car;
...
public class SwimmerTableModel extends AbstractTableModel{
	private static final long serialVersionUID = 1L;

	/**
	 * CarDAO jest wstrzykiwane
	 */
	SwimmerRemote carDAO;
	public void setCarDAO(SwimmerRemote carDAO) {	this.carDAO = carDAO; }
